      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-blue-400">ElectroMaster Solutions</h3>
            <p className="text-gray-400">
              Innovating electrical solutions for modern infrastructure. Energy-efficient, sustainable, and reliable.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="text-gray-400 space-y-2">
              ...
              <p>Tech City, TX 12345</p>
              <p>Phone: (123) 456-7890</p>
              <p>Email: contact@electrical.com</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} ElectroMaster Solutions. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
